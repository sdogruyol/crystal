...
# beside `bin/iyi` is 532 KB rather than a standard library.
.PHONY: install_iyi
...
# ships only iyi's own 532 KB answers `require "json"` with "can't find file",
...
# Its prelude is its own, and it is 532 KB: `iyi` installed as `bin/iyi` finds
